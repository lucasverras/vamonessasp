  ...
  await salvarManual(
    {
      ...
      tiktok_views_90d: intOuNull(formData.get('tiktok_views_90d')),
      tiktok_curtidas_90d: intOuNull(formData.get('tiktok_curtidas_90d')),
      tiktok_compart_90d: intOuNull(formData.get('tiktok_compart_90d')),
