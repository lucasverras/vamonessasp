 ...
 */
export function BotoesPdf({ id, nome }: { id: string; nome: string }) {
  ...
  const base = 'inline-flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-semibold disabled:opacity-60'
  return (
